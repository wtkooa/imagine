...
cppFiles = -c main.cpp src/ie_engine.cpp src/ie_const.cpp src/ie_time.cpp \
            ...
            src/ie_material.cpp src/ie_editor.cpp src/ie_terrain.cpp\
            src/ie_controller.cpp src/ie_terrain_editor.cpp\
            src/ie_asset.cpp src/ie_texture.cpp src/ie_log.cpp\
            src/ie_file_system.cpp src/ie_communication.cpp \
            src/ie_messages.cpp
...
objectFiles = main.o ie_engine.o ie_const.o ie_time.o ie_mesh.o ie_material.o\
              ...
              ie_import.o ie_editor.o ie_terrain_editor.o\
              ie_controller.o ie_asset.o ie_texture.o ie_log.o\
              ie_file_system.o ie_communication.o ie_messages.o
