...
cppFiles = -c main.cpp src/ie_engine.cpp src/ie_const.cpp src/ie_time.cpp \
            ...
            src/ie_config.cpp src/ie_import.cpp\
            src/ie_terrain.cpp src/ie_material.cpp\
            src/ie_controller.cpp \
            src/ie_asset.cpp src/ie_texture.cpp \
...
objectFiles = main.o ie_engine.o ie_const.o ie_time.o ie_mesh.o ie_material.o\
              ...
              ie_terrain.o ie_import.o\
              ie_controller.o ie_asset.o ie_texture.o \
